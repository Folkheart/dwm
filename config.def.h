...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_j,      resizefheight,  {.ui = +10 }},
	{ MODKEY|ControlMask,           XK_k,      resizefheight,  {.ui = -10 }},
	{ MODKEY|ControlMask,           XK_l,      resizefwidth,   {.ui = +10 }},
	{ MODKEY|ControlMask,           XK_h,      resizefwidth,   {.ui = -10 }},
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
